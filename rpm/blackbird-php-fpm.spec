...
Summary: Get monitorring stats of php-fpm for blackbird
Name: %{name}
Version: %{version}
...
* Project Page: https://github.com/Vagrants/blackbird-php-fpm
...
cp -p php-fpm.cfg $RPM_BUILD_ROOT/%{blackbird_conf_dir}/php-fpm.cfg
...
%changelog
* Mon Feb 17 2014 makochi <makocchi@gmail.com> - 0.1.1
- version up to 0.1.1
